    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app', models.ForeignKey(verbose_name='\u5e94\u7528', on_delete=models.CASCADE, to='app.App', help_text='\u6587\u4ef6\u5939\u5219\u6b64\u5b57\u6bb5\u4e3a\u7a7a', null=True)),
                ('parent', models.ForeignKey(verbose_name='APP\u6240\u5728\u7684\u6587\u4ef6\u5939', on_delete=models.CASCADE, blank=True, to='desktop.UserApp', null=True)),
                ('user', models.ForeignKey(verbose_name='\u7528\u6237', on_delete=models.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['id'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(verbose_name='\u7528\u6237', on_delete=models.CASCADE, to=settings.AUTH_USER_MODEL, unique=True)),
            ],
            options={
