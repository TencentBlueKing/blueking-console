    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('bk_app', models.ForeignKey(to='engine.BkApp', on_delete=models.CASCADE)),
            ],
            options={
                'ordering': ('created_at',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('bk_app_event', models.ForeignKey(to='engine.BkAppEvent', on_delete=models.CASCADE)),
            ],
            options={
                'ordering': ('created_at',),
        ...
        migrations.AddField(
            ...
            name='bk_server',
            field=models.ForeignKey(to='engine.BkServer', on_delete=models.CASCADE),
        ),
    ]
