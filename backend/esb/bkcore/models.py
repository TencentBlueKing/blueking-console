...
class ESBBuffetComponent(models.Model):
    ...
    mappings_input = models.CharField(
        _(u"输入Mappings"), null=True, default="", blank=True, max_length=1024, help_text=_(u"JSON格式数据")
    )
    mappings_output = models.CharField(
        _(u"输出Mappings"), null=True, default="", blank=True, max_length=1024, help_text=_(u"JSON格式数据")
    )
