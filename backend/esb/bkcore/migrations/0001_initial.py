    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('system', models.ForeignKey(verbose_name='\u6240\u5c5e\u7cfb\u7edf', on_delete=models.CASCADE, blank=True, to='bkcore.ComponentSystem', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('component_system', models.ForeignKey(verbose_name='\u6240\u5c5e\u7ec4\u4ef6\u7cfb\u7edf', on_delete=models.CASCADE, to='bkcore.ComponentSystem', null=True)),
            ],
            options={
