...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='esbbuffetcomponent',
            name='system',
            field=models.ForeignKey(verbose_name='\u7cfb\u7edf', on_delete=models.CASCADE, blank=True, to='bkcore.ComponentSystem', null=True),
        ),
        migrations.AlterField(
            model_name='esbbuffetcomponent',
            name='timeout_time',
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(verbose_name='\u6240\u5c5e\u7cfb\u7edf', on_delete=models.CASCADE, to='bkcore.ComponentSystem', null=True),
        ),
        migrations.AlterField(
            model_name='esbchannel',
            name='is_hidden',
