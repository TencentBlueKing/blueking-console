    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app', models.ForeignKey(blank=True, to='app.App', on_delete=models.CASCADE, null=True)),
            ],
            options={
                'ordering': ('-code',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('saas_app', models.ForeignKey(to='saas.SaaSApp', on_delete=models.CASCADE)),
                ('upload_file', models.ForeignKey(to='saas.SaaSUploadFile', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, to='saas.SaaSAppVersion', on_delete=models.CASCADE, null=True),
        ),
    ]
